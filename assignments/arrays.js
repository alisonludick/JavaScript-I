...
// for (let i = 0; i < inventory.length; i++) {
//   console.log(Car ${this.id} is a ${this.car_make} ${this.car_model} ${this.car_year}.);
// } THE WRONG CODE THAT TOOK MORE THAN AN HOUR TO FIX! 


// ==== Challenge 2 ====
// The dealer needs the information on the last car in their inventory.  What is the make and model of the last car in the inventory?  Log the make and model into the console.
let lastCar = 0;
console.log(`The make and model of the last car is a ${inventory[inventory.length-1].car_make} ${inventory[inventory.length-1].car_model} `);
...
console.log(`car models listed alphabetically: ` + carModels.sort());

// as an extra, here is an alphabetic list according to car make:
let carMake = [];
for (let i = 0; i < inventory.length; i++) {
    carMake.push(inventory[i].car_make);
}
console.log(`alphabetic list of car make: ` + carMake.sort());
...
console.log(`all the years from every car on the lot: ` + carYears);
...
console.log(`number of cars are older than the year 2000: ` + oldCars.length);
...
console.log(`only BMW and Audi cars: ` + BMWAndAudi);
